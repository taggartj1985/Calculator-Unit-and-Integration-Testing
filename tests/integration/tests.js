...
describe('calculator functionality', function() {
  ...
  it('should output for a range of large numbers', function(){
    running_total = element(by.css('#running_total'))
  ...
  it('should output for a range of decimals numbers', function(){
    running_total = element(by.css('#running_total'))
...
// if you divide by zero, what is the effect? Write a test to describe what you’d
// prefer to happen, and then correct the code to make that test pass
